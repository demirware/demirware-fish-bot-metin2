...
from window_manager import WindowManager, GameRegion, WindowActivationError
...
class FishingBot:
    ...
    def start(self):
        ...
        try:
            ...
            # Startup inventory navigation happens before play_game's loop-level
            # handler. Do not leave the GUI showing a worker that already exited.
            self._stop_bot(self.STOP_ERROR, f"[W{self.bot_id+1}] {e}")
